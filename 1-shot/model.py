...
class Mnet(nn.Module):
    ...
    def forward(self, input, input_th, input_d, s_input, s_input_th, s_input_d, s_mask, text_O, text_A, text_R, text, name):
        ...
        image1, image2, image3, image4 = image_feat
