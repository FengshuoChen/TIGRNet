...
def main(model):
    ...
    # Test HSNet
    with torch.no_grad():
        test_miou, test_fb_iou = test(model, val_loader, sub_val_list, args.shot)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--datapath', type=str, default='/home/baoliuxin/find/VDT-2048-5i')
    parser.add_argument('--benchmark', type=str, default='pascal', choices=['pascal', 'coco', 'fss'])
    parser.add_argument('--logpath', type=str, default='')
    parser.add_argument('--bsz', type=int, default=1)
    parser.add_argument('--nworker', type=int, default=1)
    parser.add_argument('--load', type=str, default='./logs/fold0/')
